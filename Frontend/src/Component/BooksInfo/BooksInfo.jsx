...
const ImgInfo = () => {
  ...
  return (
    <div className={`${darkMode ? 'bg-black/90 text-white' : 'bg-gray-100 text-black'}`}>
      <div className="px-6 md:px-20 py-4 flex flex-col md:flex-row gap-10">
        ...
        <div className='flex justify-center'>
          <div>
            ...
            <p className="mb-2"><span className='font-bold'>Author :</span> {book.author}</p>
            <p className="mb-2"><span className='font-bold'>Publisher :</span> {book.Publisher}</p>
