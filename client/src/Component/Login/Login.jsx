...
//           {otpSent ? "VERIFY YOUR OTP" : "LOGIN TO BUYBOOKS"}
//         </h1>
...
//               onChange={(e) => setMobileno(e.target.value.replace(/\D/, ""))}
//               className={`flex-1 p-2 outline-none ${
//                 darkMode ? "text-white placeholder-gray-400 bg-transparent" : "text-black placeholder-gray-500"
//               }`}
//               disabled={otpSent}
//             />
//           </div>
...
//               darkMode ? "border-gray-600 text-white placeholder-gray-400 bg-transparent" : "border-gray-400 text-black placeholder-gray-500"
//             }`}
//             disabled={otpSent}
//           />
...
//             onChange={(e) => setPassword(e.target.value)}
//             className={`border-2 rounded-lg p-2 outline-none ${
//               darkMode ? "border-gray-600 text-white placeholder-gray-400 bg-transparent" : "border-gray-400 bg-white text-black placeholder-gray-500"
//             }`}
//             disabled={otpSent}
//           />
...
//                 type="button"
//                 onClick={handleVerifyOtp}
//                 className={`bg-orange-500 w-full p-2 rounded-lg flex items-center justify-center hover:bg-orange-600 ${
//                   darkMode ? "text-white" : "text-black"
//                 }`}
//               >
//                 <FaUser className="mr-2" /> Verify & Login
//               </button>
//             </>
//           ) : (
//             <button
//               type="submit"
//               className={`bg-orange-500 w-full p-2 rounded-lg hover:bg-orange-600 ${
//                 darkMode ? "text-white" : "text-black"
//               }`}
//             >
//               Generate OTP
