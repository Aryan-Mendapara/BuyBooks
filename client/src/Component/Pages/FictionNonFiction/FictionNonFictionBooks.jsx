...
const FictionNonFictionBooks = () => {
    ...
    return (
        <div className='bg-gray-100 text-center py-4 mx-auto'>
            <div className="max-w-6xl mx-auto px-2 py-8">
                {/* Title */}
                <div className="text-center mb-6">
                    {/* Desktop & larger screens */}
                    <div className="hidden md:block">
                        <h2 className="text-4xl font-bold">Fiction & Non Fiction Books</h2>
                        <div className="w-120 h-0.5 bg-orange-500 mx-auto mt-2"></div>
                    </div>

                    {/* Mobile & small screens */}
                    <div className="md:hidden">
                        <h2 className="text-3xl font-bold">Fiction & Non Fiction Books</h2>
